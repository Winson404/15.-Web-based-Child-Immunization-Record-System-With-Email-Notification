  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="about_me.php" class="d-block"><?php echo ' '.$row['user_firstname'].' '.$row['user_middlename'].' '.$row['user_lastname'].' '.$row['user_suffix'].' '; ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header text-secondary">ACCOUNT STATUS: 
            <?php if($row['user_status'] == 'Pending'): ?>
                <h5 class="badge badge-danger rounded-pill p-1">&nbsp; &nbsp; Pending</h5>
              <?php else: ?>
                <h5 class="badge badge-success rounded-pill p-1">Approved</h5>
              <?php endif; ?>
          </li>
          ...
          <li class="nav-header text-secondary">RECORD</li>
          <li class="nav-item">
            <a href="immmunization_vaccination.php" class="nav-link text-light">
              <i class="fa-solid fa-syringe"></i>
              <p>&nbsp;&nbsp; Immunization Vaccination Record</p>
            </a>
          </li>
