      ...
      if(mysqli_num_rows($fetch) > 0) {
          ...
          if($check_code == NULL) {
                ...
                if($insert_code) {
                    ...
                    <p>You can change your password by just clicking it <a href="http://localhost/PROJECT%2018.%20WEB-BASED%20CHILD%20IMMUNIZATION/changepassword2.php?user_Id='.$user_Id.'&&email='.$email.'&&key='.$code.'">here!</a></p> 
