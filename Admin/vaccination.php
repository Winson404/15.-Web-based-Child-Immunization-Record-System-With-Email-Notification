<title>Vaccination management  | Child Immunization Vaccine Record System</title>
...
?>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Vaccination management </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody id="users_data">
                    <tr>
                      ...
                      ?>
                        ...
                        <td>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#update<?php echo $row['vaccine_Id']; ?>"><i class="fa-solid fa-pen-to-square"></i></button>
                    ...
                    <?php include 'vaccination_update_delete.php';  }  ?>
 ...
 <?php include 'vaccination_add.php';  ?>
