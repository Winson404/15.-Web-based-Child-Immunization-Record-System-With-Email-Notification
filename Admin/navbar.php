...
<head>
  ...
  <title>Child Immunization Vaccine Record System</title>
 ...
 <!--  <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Child Immunization Vaccine Record System</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!--   <li class="nav-item">
            <a href="users.php" class="nav-link"><i class="fa-solid fa-users"></i><p>&nbsp;&nbsp; List of children</p></a>
          </li>
 -->
          ...
          <li class="nav-item">
            <a href="#" class="nav-link text-light">
              ...
              <p>&nbsp;&nbsp; List of children<i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="archived.php" class="nav-link text-light">
          ...
          <li class="nav-header text-secondary">SCHEDULE</li>
          <li class="nav-item">
            <a href="schedule.php" class="nav-link"><i class="fa-solid fa-calendar-days"></i><p>&nbsp;&nbsp; Schedule</p></a>
          </li>

          <li class="nav-header text-secondary">IMMUNIZATION VACCINATION</li>
          <li class="nav-item">
            <a href="vaccination.php" class="nav-link"><i class="fa-solid fa-syringe"></i><p>&nbsp;&nbsp; Immunization Vaccination Mgmt.</p></a>
          </li>
          ...
          <li class="nav-header text-light mb-3" onclick="logout()"><h6 type="button"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp; Logout</h6></li>
          <!-- <li class="nav-item">
