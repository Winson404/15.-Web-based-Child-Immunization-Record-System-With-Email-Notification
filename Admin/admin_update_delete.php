...
<div class="modal fade" id="view<?php echo $row['admin_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer alert-light">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#update<?php echo $row['admin_Id']; ?>" data-dismiss="modal"><i class="fa-solid fa-user-pen"></i> Update</button>
      </div>
    </div>
  </div>
</div>
