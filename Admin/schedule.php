<title>Schedule | Child Immunization Vaccine Record System</title>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM users JOIN schedule ON users.user_Id=schedule.user_Id");
                      ...
                      ?>
                        ...
                        <td>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#update<?php echo $row['user_Id']; ?>"><i class="fa-solid fa-pen-to-square"></i></button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo $row['user_Id']; ?>"><i class="fa-solid fa-trash-can"></i></button>
                        </td> 
                    </tr>
