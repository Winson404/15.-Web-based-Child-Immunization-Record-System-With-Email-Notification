<title>Registered children | Child Immunization Vaccine Record System</title>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Registered children</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      ?>
                        ...
                        <td>
                          <?php if($row['user_status'] == 'Pending'): ?>
                            <span type="button" class="badge badge-danger rounded-pill p-1" data-toggle="modal" data-target="#approve<?php echo $row['user_Id']; ?>"><?php echo $row['user_status']; ?></span>
                          <?php else: ?>
                            <span class="badge badge-info rounded-pill p-1"><?php echo $row['user_status']; ?></span>
                          <?php endif; ?>
                        </td>
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#archive<?php echo $row['user_Id']; ?>">Archive</button>
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#schedule<?php echo $row['user_Id']; ?>">Add schedule</button>
                                      <a href="immmunization_vaccination.php?user_Id=<?php echo $row['user_Id']; ?>" class="btn btn-primary dropdown-item">Immunization vacc. record</a>
                                </div>
                            </div>
                        </td> 
                    </tr>

                    <?php include 'users_update_delete.php'; endif; }  ?>
