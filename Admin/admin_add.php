...
<script>
    function validate_password() {
      ...
      if (pass != confirm_pass) {
        ...
        document.getElementById('admincreate').disabled = true;
        document.getElementById('admincreate').style.opacity = (0.4);
      } else {
        document.getElementById('wrong_pass_alert').style.color = 'green';
        document.getElementById('wrong_pass_alert').innerHTML = '✓ Password matched!';
        document.getElementById('admincreate').disabled = false;
        document.getElementById('admincreate').style.opacity = (1);
      }
    }
