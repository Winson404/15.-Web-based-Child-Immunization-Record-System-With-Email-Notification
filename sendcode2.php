      ...
      <form action="verifycode.php" method="POST">
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="text-center mb-4"><?php echo ' '.$row['user_firstname'].' '.$row['user_middlename'].' '.$row['user_lastname'].' '.$row['user_suffix'].' '; ?></p>
          </div>
      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-body">
          <h5 class="login-box-msg">Sorry, your account does not exist.</h5>
              <div class="col-md-12">
                <div class="input-group mb-3">
                  <img src="images/USER_NOTFOUND.png" alt="" style="width: 100px;  display: block;margin-left: auto;margin-right: auto;margin-bottom: -12px;">
                </div>
              </div>
          <div class="social-auth-links text-center mt-4">
